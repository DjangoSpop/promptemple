# PromptCraft Django Backend - Production Ready API
...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="promptcraft"),
...
DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default="noreply@promptcraft.app")
